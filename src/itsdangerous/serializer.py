...
if _t.TYPE_CHECKING:
    ...
    _t_fallbacks = _t.List[
        _t.Union[_t_kwargs, _t.Tuple[_t_signer, _t_kwargs], _t_signer]
    ]
...
class Serializer:
    ...
    def __init__(
        ...
        fallback_signers: "_t_fallbacks" = None,
    ):
    ...
    def loads(
        self, s: "_t_str_bytes", salt: "_t_opt_str_bytes" = None, **kwargs
    ) -> _t.Any:
    ...
    def load_unsafe(
        self, f: _t.IO, salt: "_t_opt_str_bytes" = None
    ) -> "_t_load_unsafe":
