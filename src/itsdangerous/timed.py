...
if _t.TYPE_CHECKING:
    ...
    _t_signer = _t.Type["TimestampSigner"]
...
class TimestampSigner(Signer):
    ...
    def timestamp_to_datetime(self, ts) -> datetime:
    ...
    # parameter that affects the return type. Flake8 only understands
    # the name "@typing.overload", ignore its redefinition check.

    @_t.overload
    def unsign(  # type: ignore [misc]
        self,
    ...
    def validate(
        self, signed_value: "_t_str_bytes", max_age: "_t_opt_int" = None
    ) -> bool:
